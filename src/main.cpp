...
int main(int argc, char **argv)
{
	...
	QCoreApplication::setApplicationName("asterium");
	QCoreApplication::setApplicationVersion(StelUtils::getApplicationPublicVersion());
	QCoreApplication::setOrganizationDomain("asterium.org");
	QCoreApplication::setOrganizationName("asterium");
	QGuiApplication::setDesktopFileName("org.asterium.Asterium");
