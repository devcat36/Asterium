...
{
	return QString("Asterium %1").arg(STELLARIUM_BUIDING_VERSION); // see lines 158-188 in CMakeLists.txt
}
...
{
	return QString("Asterium/%1 (%2; %3)").arg(StelUtils::getApplicationPublicVersion(), StelUtils::getOperatingSystemInfo(), QSysInfo::currentCpuArchitecture());
}
