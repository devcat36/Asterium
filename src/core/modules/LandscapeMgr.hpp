...
class LandscapeMgr : public StelModule
{
	...
	Q_PROPERTY(bool flagLandscapeAutoTransparency
		   READ getFlagLandscapeAutoTransparency
		   WRITE setFlagLandscapeAutoTransparency
		   NOTIFY flagLandscapeAutoTransparencyChanged)
...
public slots:
	...
	bool getFlagLandscapeAutoTransparency() const;
	void setFlagLandscapeAutoTransparency(bool b);
	double getEffectiveLandscapeTransparency() const;
...
signals:
	...
	void flagLandscapeAutoTransparencyChanged(const bool value);
...
private:
	...
	bool flagLandscapeAutoTransparency;
	double autoTransparency;
