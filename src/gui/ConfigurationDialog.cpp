...
void ConfigurationDialog::createDialogContent()
{
	...
	connect(ui->saveSettingsAsDefaultPushButton, &QPushButton::clicked,
	        this, [this]() { saveAllSettings(true); });
...
void ConfigurationDialog::saveAllSettings(bool includeDefaultLocation)
{
	QSettings* conf = StelApp::getInstance().getSettings();
	Q_ASSERT(conf);
